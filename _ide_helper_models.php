 ...
 * @property string|null $description 任務描述
 * @property string $status 任務狀態
 * @property int $priority 任務優先度
 * @property string|null $due_date 任務截止日期
 * @property string|null $tags 任務標籤
 * @property string|null $category 任務分類
